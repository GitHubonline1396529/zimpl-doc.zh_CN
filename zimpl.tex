...
% If an in-line code box only contains one single symbol, 
% it may not be clearly visible within the lines of Chinese text. 
% Therefore, we need to color it.
...
\newcommand{\code}[1]{\textcolor{magenta}{\tt #1}\xspace}
